...
namespace model_wei_dyn_bin_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_wei_dyn_bin");
    reader.add_event(105, 103, "end", "model_wei_dyn_bin");
    return reader;
}
#include <stan_meta_header.hpp>
class model_wei_dyn_bin : public prob_grad {
private:
        int M;
        int Mgen;
        int Nt;
...
public:
    model_wei_dyn_bin(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_wei_dyn_bin_namespace::model_wei_dyn_bin";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_wei_dyn_bin_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_wei_dyn_bin_namespace::model_wei_dyn_bin stan_model;
#endif

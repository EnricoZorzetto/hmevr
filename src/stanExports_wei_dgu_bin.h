...
namespace model_wei_dgu_bin_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_wei_dgu_bin");
    reader.add_event(132, 130, "end", "model_wei_dgu_bin");
    return reader;
}
#include <stan_meta_header.hpp>
class model_wei_dgu_bin : public prob_grad {
private:
        int M;
        int Mgen;
        int Nt;
...
public:
    model_wei_dgu_bin(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_wei_dgu_bin_namespace::model_wei_dgu_bin";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(gumbel_log<propto__>(C, mc, sc));
            current_statement_begin__ = 54;
            lp_accum__.add(gumbel_log<propto__>(w, mw, sw));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_wei_dgu_bin_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            while (as_bool(logical_lt(count_c, Mgen))) {
                ...
                stan::math::assign(genc, gumbel_rng(mc, sc, base_rng__));
            ...
            while (as_bool(logical_lt(count_w, Mgen))) {
                ...
                stan::math::assign(genw, gumbel_rng(mw, sw, base_rng__));
...
typedef model_wei_dgu_bin_namespace::model_wei_dgu_bin stan_model;
#endif

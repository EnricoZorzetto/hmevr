...
```{r}
dynfit <- fit_ev_model(data, model = 'wei_dgu_bin', iter = iter, chains=chains , 
...
dbbq <- comp_quant(dbbfit, maxima, trmin = trmin)
...
p1 <- ggplot() +
  ...
  geom_line(aes(  dbbq$TrvalQ, dbbq$qmean),  linetype="solid",color= "orange") +
  geom_line(aes(  dbbq$TrvalQ, dbbq$qupper), linetype="dashed",color="orange") +
  geom_line(aes(  dbbq$TrvalQ, dbbq$qlower), linetype="dashed",color="orange") +
...
p2 <- ggplot() +
  ...
  geom_line(aes(  dbbq$Xival, dbbq$fmean),  linetype="solid",color= "orange") +
  geom_line(aes(  dbbq$Xival, dbbq$fupper), linetype="dashed",color="orange") +
  geom_line(aes(  dbbq$Xival, dbbq$flower), linetype="dashed",color="orange") +
